...
class QTFModel(TFModelV2):
    """Extension of standard TFModelV2 to provide extra functionalities.

    Supports options for noisy nets and parameter space noise.
    ...
    def __init__(
        ...
        * This only defines layers for the Q head
        * Core layers for forward() are defined in subclass of QTFModel.

        """
        super(QTFModel, self).__init__(
