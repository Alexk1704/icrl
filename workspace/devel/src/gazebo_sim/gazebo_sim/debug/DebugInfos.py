...
class DebugInfoSim(Node):
    def __init__(self, config) -> None:
        ...
        # task/episode
        self.env_switch = self.create_subscription(EmptyMsg, f'{world_name}/switch', self.handle_switch_callback, qos_profile, callback_group=group_1)
        self.env_reset = self.create_subscription(EmptyMsg, f'{world_name}/reset', self.handle_reset_callback, qos_profile, callback_group=group_1)
    ...
    def handle_switch_callback(self, msg):
        self.dump_infos('switch')

    def handle_reset_callback(self, msg):
