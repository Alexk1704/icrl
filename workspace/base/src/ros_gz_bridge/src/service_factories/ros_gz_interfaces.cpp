...
{
  if (
    ros_type_name == "ros_gz_interfaces/srv/AdjustPhysics" &&
    (gz_req_type_name.empty() || gz_req_type_name == "gz.msgs.Physics") &&
    (gz_rep_type_name.empty() || gz_rep_type_name == "gz.msgs.Boolean"))
  {
    return std::make_shared<
      ServiceFactory<
        ros_gz_interfaces::srv::AdjustPhysics,
        gz::msgs::Physics,
        gz::msgs::Boolean>
    >(ros_type_name, "gz.msgs.Physics", "gz.msgs.Boolean");
  }
...
void
convert_ros_to_gz(
  const ros_gz_interfaces::srv::AdjustPhysics::Request & ros_req,
  gz::msgs::Physics & gz_req)
{
  convert_ros_to_gz(ros_req.physics, gz_req);
}
...
convert_gz_to_ros(
  ...
  ros_gz_interfaces::srv::AdjustPhysics::Response & ros_res)
{
...
convert_ros_to_gz(
  ...
  gz::msgs::Pose & gz_req)
{
  gz_req.set_name(ros_req.entity.name);
...
template<>
bool
send_response_on_error(ros_gz_interfaces::srv::AdjustPhysics::Response & ros_res)
{
